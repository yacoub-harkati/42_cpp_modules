...
/*   Updated: 2024/07/07 12:26:21 by yaharkat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((_firstName == "    --    " || _firstName == "") && (_lastName == "    --    ")
		&& (_nickName == "    --    " || _nickName == "") && (_phoneNumber == "    --    " || _phoneNumber == "")
		&& (_darkestSecret == "    --    " || _darkestSecret == ""))
		return true;
	else
		return false;
}
